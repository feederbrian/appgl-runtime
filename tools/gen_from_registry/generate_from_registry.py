...
def generate_public_header(
    ...
    lines: list[str] = []
    lines.append("/*")
    lines.append(" * Generated by runtime/tools/gen_from_registry/generate_from_registry.py")
    lines.append(" * Inputs:")
    lines.append(" *   - runtime/tools/gen_from_registry/khronos/gl.xml")
    lines.append(" *   - runtime/tools/gen_from_registry/khronos/glcorearb.h")
    lines.append(" *   - runtime/tools/gen_from_registry/khronos/khrplatform.h")
    lines.append(" */")
    lines.append("")
...
def generate_enums_header(enums: list[dict[str, str]]) -> str:
    lines = [
        "#pragma once",
        "",
        "// Generated by runtime/tools/gen_from_registry/generate_from_registry.py",
        "",
    ]
    for enum in enums:
        lines.append(f"#ifndef {enum['name']}")
