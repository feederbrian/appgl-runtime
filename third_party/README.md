...
| `SPIRV-Cross` | `https://github.com/KhronosGroup/SPIRV-Cross` | `601164c16ba27c8f375277115fa719c22b58ed71` | Apache-2.0 or MIT, see `SPIRV-Cross/LICENSE` and `SPIRV-Cross/LICENSES/` |
