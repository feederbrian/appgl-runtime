...
`appgl_sparse_sampled_sidecar_<slot>` using the regular non-sparse
texture operation. The `// APPGL_SPARSE_SAMPLED_SIDECAR` marker lets
AppGL inject the extra sidecar texture parameter after SPIRV-Cross
emission.
