 ...
 * Inputs:
 *   - runtime/tools/gen_from_registry/khronos/gl.xml
 *   - runtime/tools/gen_from_registry/khronos/glcorearb.h
 *   - runtime/tools/gen_from_registry/khronos/khrplatform.h
 */
