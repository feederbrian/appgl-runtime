...
bool isFormatTypeCompatible(GLenum format, GLenum type) {
    ...
    const bool isRGBA_family = (format == GL_RGBA || format == GL_RGBA_INTEGER
        ...
        || (format == GL_ABGR_EXT && appglCompatProfileEnabled()));
...
std::size_t Runtime::writeDiagnosticsJSON(char* out, std::size_t cap) {
    ...
    stream << ","
           ...
           << metalInventory.mslLibraryCacheSourceBytes << ","
           << "\"mslLibraryCacheSourceKeyBytes\":"
           << metalInventory.mslLibraryCacheSourceKeyBytes << ","
           << "\"mslLibraryCompileTransientSourceBytes\":"
           << metalInventory.mslLibraryCompileTransientSourceBytes << ","
           << "\"mslLibraryCacheHits\":"
           << metalInventory.mslLibraryCacheHits << ","
           << "\"mslLibraryCacheMisses\":"
           << metalInventory.mslLibraryCacheMisses << ","
           << "\"mslLibrarySourceNSStringCreations\":"
           << metalInventory.mslLibrarySourceNSStringCreations << ","
           ...
           << "\"fboClearsDeferred\":"
           << metalInventory.frameGraphFboClearsDeferred << ","
           << "\"fboClearsFolded\":"
           << metalInventory.frameGraphFboClearsFolded << ","
           << "\"fboClearsMaterialized\":"
           << metalInventory.frameGraphFboClearsMaterialized << ","
           << "\"fboClearsCoalesced\":"
           << metalInventory.frameGraphFboClearsCoalesced << ","
           << "\"encoderOpensFboDraw\":"
           << metalInventory.frameGraphEncoderOpensFboDraw << ","
           << "\"encoderOpensDefaultFb\":"
           << metalInventory.frameGraphEncoderOpensDefaultFb << ","
           << "\"encoderClosesFboTargetChange\":"
           << metalInventory.frameGraphEncoderClosesFboTargetChange << ","
           << "\"encoderClosesShadingRateChange\":"
           << metalInventory.frameGraphEncoderClosesShadingRateChange << ","
           << "\"encoderClosesViewportRequestInvalidate\":"
           << metalInventory.frameGraphEncoderClosesViewportRequestInvalidate << ","
           << "\"encoderClosesReadback\":"
           << metalInventory.frameGraphEncoderClosesReadback << ","
           ...
           << "\"prepMemoBustsByDomain\":["
           << metalInventory.prepMemoBustsByDomain[0] << ","
           << metalInventory.prepMemoBustsByDomain[1] << ","
           << metalInventory.prepMemoBustsByDomain[2] << ","
           << metalInventory.prepMemoBustsByDomain[3] << ","
           << metalInventory.prepMemoBustsByDomain[4] << ","
           << metalInventory.prepMemoBustsByDomain[5] << "],"
           << "\"prepMemoMisses\":"
           << metalInventory.prepMemoMisses << ","
           << "\"samplerResolveCache\":["
           << metalInventory.samplerResolveCacheHits << ","
           ...
           << "\"prepMemoBusts\":"
           << metalInventory.prepMemoBusts << ","
           << "\"shadowClearsDeferred\":"
           << metalInventory.shadowClearsDeferred << ","
           << "\"shadowClearsCoalesced\":"
           << metalInventory.shadowClearsCoalesced << ","
           << "\"shadowClearsMaterialized\":"
           << metalInventory.shadowClearsMaterialized << ","
           << "\"shadowClearMaterializeBytes\":"
           << metalInventory.shadowClearMaterializeBytes << ","
           << "\"bufferRenames\":"
           << metalInventory.bufferRenames << ","
           << "\"bufferRenameBytes\":"
           << metalInventory.bufferRenameBytes << ","
           << "\"bufferRenameSkips\":"
           << metalInventory.bufferRenameSkips << ","
           << "\"translatedDrawEncodeCalls\":"
           << metalInventory.frameGraphTranslatedDrawEncodeCalls << ","
           << "\"passDescriptorBuilds\":"
           << metalInventory.frameGraphPassDescriptorBuilds << ","
           << "\"passDescriptorBuildUsTotal\":"
           << metalInventory.frameGraphPassDescriptorBuildUsTotal << ","
           << "\"fboPassContinuations\":"
           << metalInventory.frameGraphFboPassContinuations << ","
           << "\"fboPassSignatureMisses\":"
           << metalInventory.frameGraphFboPassSignatureMisses << ","
           ...
           << "\"defaultMsaaColorTextureBytes\":"
           << metalInventory.frameGraphDefaultMsaaColorTextureBytes << ","
           << "\"defaultMsaaColorTextureWidth\":"
           << metalInventory.frameGraphDefaultMsaaColorTextureWidth << ","
           << "\"defaultMsaaColorTextureHeight\":"
           << metalInventory.frameGraphDefaultMsaaColorTextureHeight << ","
           << "\"defaultMsaaColorTextureSampleCount\":"
           << metalInventory.frameGraphDefaultMsaaColorTextureSampleCount << ","
           << "\"defaultMsaaColorTexturePixelFormat\":"
           << metalInventory.frameGraphDefaultMsaaColorTexturePixelFormat << ","
           << "\"defaultMsaaColorRebuilds\":"
           << metalInventory.frameGraphDefaultMsaaColorRebuilds << ","
           << "\"defaultMsaaColorReleases\":"
           << metalInventory.frameGraphDefaultMsaaColorReleases << ","
           << "\"defaultMsaaColorAllocatedBytes\":"
           << metalInventory.frameGraphDefaultMsaaColorAllocatedBytes << ","
           << "\"defaultMsaaDepthStencilTextureBytes\":"
           << metalInventory.frameGraphDefaultMsaaDepthStencilTextureBytes << ","
           << "\"defaultMsaaDepthStencilTextureWidth\":"
           << metalInventory.frameGraphDefaultMsaaDepthStencilTextureWidth << ","
           << "\"defaultMsaaDepthStencilTextureHeight\":"
           << metalInventory.frameGraphDefaultMsaaDepthStencilTextureHeight << ","
           << "\"defaultMsaaDepthStencilTextureSampleCount\":"
           << metalInventory.frameGraphDefaultMsaaDepthStencilTextureSampleCount << ","
           << "\"defaultMsaaDepthStencilTexturePixelFormat\":"
           << metalInventory.frameGraphDefaultMsaaDepthStencilTexturePixelFormat << ","
           << "\"defaultMsaaDepthStencilRebuilds\":"
           << metalInventory.frameGraphDefaultMsaaDepthStencilRebuilds << ","
           << "\"defaultMsaaDepthStencilReleases\":"
           << metalInventory.frameGraphDefaultMsaaDepthStencilReleases << ","
           << "\"defaultMsaaDepthStencilAllocatedBytes\":"
           << metalInventory.frameGraphDefaultMsaaDepthStencilAllocatedBytes << ","
           << "\"defaultMsaaColorResolveDirty\":"
           << metalInventory.frameGraphDefaultMsaaColorResolveDirty << ","
           ...
           << "},";
    stream << "\"residency\":{"
           << "\"records\":" << metalInventory.residency.records << ","
           << "\"retainedBytes\":" << metalInventory.residency.retainedBytes
           << ","
           << "\"metalBytes\":" << metalInventory.residency.metalBytes << ","
           << "\"hostBytes\":" << metalInventory.residency.hostBytes << ","
           << "\"authoritativeRecords\":"
           << metalInventory.residency.authoritativeRecords << ","
           << "\"authoritativeBytes\":"
           << metalInventory.residency.authoritativeBytes << ","
           << "\"reconstructableRecords\":"
           << metalInventory.residency.reconstructableRecords << ","
           << "\"reconstructableBytes\":"
           << metalInventory.residency.reconstructableBytes << ","
           << "\"transientRecords\":"
           << metalInventory.residency.transientRecords << ","
           << "\"transientBytes\":" << metalInventory.residency.transientBytes
           << ","
           << "\"sparseSpecialRecords\":"
           << metalInventory.residency.sparseSpecialRecords << ","
           << "\"sparseSpecialBytes\":"
           << metalInventory.residency.sparseSpecialBytes << ","
           << "\"unknownRecords\":"
           << metalInventory.residency.unknownRecords << ","
           << "\"unknownBytes\":" << metalInventory.residency.unknownBytes
           << ","
           << "\"hostRecords\":" << metalInventory.residency.hostRecords
           << ","
           << "\"metalDeviceRecords\":"
           << metalInventory.residency.metalDeviceRecords << ","
           << "\"frameGraphRecords\":"
           << metalInventory.residency.frameGraphRecords << ","
           << "\"cacheRecords\":" << metalInventory.residency.cacheRecords
           << ","
           << "\"sidecarRecords\":"
           << metalInventory.residency.sidecarRecords << ","
           << "\"sparseRecords\":" << metalInventory.residency.sparseRecords
           << "},";
    stream << "\"r5DryRun\":{"
           << "\"dryRunPasses\":" << metalInventory.r5DryRun.dryRunPasses
           << ","
           << "\"recordsSeen\":" << metalInventory.r5DryRun.recordsSeen << ","
           << "\"reconstructableRecords\":"
           << metalInventory.r5DryRun.reconstructableRecords << ","
           << "\"reconstructableBytes\":"
           << metalInventory.r5DryRun.reconstructableBytes << ","
           << "\"authoritativeRecords\":"
           << metalInventory.r5DryRun.authoritativeRecords << ","
           << "\"authoritativeBytes\":"
           << metalInventory.r5DryRun.authoritativeBytes << ","
           << "\"unknownKindRecords\":"
           << metalInventory.r5DryRun.unknownKindRecords << ","
           << "\"unknownKindBytes\":"
           << metalInventory.r5DryRun.unknownKindBytes << ","
           << "\"unknownAuthorityRecords\":"
           << metalInventory.r5DryRun.unknownAuthorityRecords << ","
           << "\"unknownAuthorityBytes\":"
           << metalInventory.r5DryRun.unknownAuthorityBytes << ","
           << "\"transientExcludedRecords\":"
           << metalInventory.r5DryRun.transientExcludedRecords << ","
           << "\"transientExcludedBytes\":"
           << metalInventory.r5DryRun.transientExcludedBytes << ","
           << "\"sparseExcludedRecords\":"
           << metalInventory.r5DryRun.sparseExcludedRecords << ","
           << "\"sparseExcludedBytes\":"
           << metalInventory.r5DryRun.sparseExcludedBytes << ","
           << "\"candidateRecords\":"
           << metalInventory.r5DryRun.candidateRecords << ","
           << "\"candidateBytes\":"
           << metalInventory.r5DryRun.candidateBytes << ","
           << "\"candidateHostBytes\":"
           << metalInventory.r5DryRun.candidateHostBytes << ","
           << "\"candidateMetalBytes\":"
           << metalInventory.r5DryRun.candidateMetalBytes << ","
           << "\"candidateHostHeapBytes\":"
           << metalInventory.r5DryRun.candidateHostHeapBytes << ","
           << "\"candidateMetalDeviceHeapBytes\":"
           << metalInventory.r5DryRun.candidateMetalDeviceHeapBytes << ","
           << "\"candidateFrameGraphHeapBytes\":"
           << metalInventory.r5DryRun.candidateFrameGraphHeapBytes << ","
           << "\"candidateCacheHeapBytes\":"
           << metalInventory.r5DryRun.candidateCacheHeapBytes << ","
           << "\"candidateSidecarHeapBytes\":"
           << metalInventory.r5DryRun.candidateSidecarHeapBytes << ","
           << "\"candidateSparseHeapBytes\":"
           << metalInventory.r5DryRun.candidateSparseHeapBytes << ","
           << "\"candidateUnknownHeapBytes\":"
           << metalInventory.r5DryRun.candidateUnknownHeapBytes << ","
           << "\"futurePurgeableEligibleRecords\":"
           << metalInventory.r5DryRun.futurePurgeableEligibleRecords << ","
           << "\"futurePurgeableEligibleBytes\":"
           << metalInventory.r5DryRun.futurePurgeableEligibleBytes << ","
           << "\"pressureMutationAttempts\":"
           << metalInventory.r5DryRun.pressureMutationAttempts << ","
           << "\"purgeableStateCalls\":"
           << metalInventory.r5DryRun.purgeableStateCalls << ","
           << "\"drainRequests\":"
           << metalInventory.r5DryRun.drainRequests
           << "},";
    stream << "\"r5Eviction\":{"
           << "\"version\":" << metalInventory.r5Eviction.version << ","
           ...
           << "\"passCompleted\":"
           << metalInventory.r5Eviction.passCompleted << ","
           << "\"passSkippedDisabled\":"
           ...
           << "\"drainFailures\":"
           << metalInventory.r5Eviction.drainFailures << ","
           << "\"candidatesSeen\":"
           << metalInventory.r5Eviction.candidatesSeen << ","
           << "\"eligibleSeen\":"
           << metalInventory.r5Eviction.eligibleSeen << ","
           << "\"selectedRecords\":"
           << metalInventory.r5Eviction.selectedRecords << ","
           << "\"mutatedRecords\":"
           << metalInventory.r5Eviction.mutatedRecords << ","
           << "\"budgetSkippedRecords\":"
           << metalInventory.r5Eviction.budgetSkippedRecords << ","
           << "\"unknownLastUseSkipped\":"
           << metalInventory.r5Eviction.unknownLastUseSkipped << ","
           << "\"scopeSkipped\":"
           << metalInventory.r5Eviction.scopeSkipped << ","
           << "\"objectMissingSkipped\":"
           << metalInventory.r5Eviction.objectMissingSkipped << ","
           << "\"handleMissingSkipped\":"
           << metalInventory.r5Eviction.handleMissingSkipped << ","
           << "\"generationMismatchSkipped\":"
           << metalInventory.r5Eviction.generationMismatchSkipped << ","
           << "\"lastUseMismatchSkipped\":"
           << metalInventory.r5Eviction.lastUseMismatchSkipped << ","
           << "\"samplingProxySkipped\":"
           << metalInventory.r5Eviction.samplingProxySkipped << ","
           << "\"textureViewBaseReleaseAttempts\":"
           << metalInventory.r5Eviction.textureViewBaseReleaseAttempts << ","
           << "\"textureViewBaseReleaseSuccesses\":"
           << metalInventory.r5Eviction.textureViewBaseReleaseSuccesses << ","
           << "\"swizzledViewReleaseAttempts\":"
           ...
           << metalInventory.r5Eviction.expandedIndexClearSuccesses << ","
           << "\"primaryTextureReleaseAttempts\":"
           << metalInventory.r5Eviction.primaryTextureReleaseAttempts << ","
           << "\"primaryTextureReleaseSuccesses\":"
           << metalInventory.r5Eviction.primaryTextureReleaseSuccesses << ","
           << "\"authoritativePrimaryEvictAttempts\":"
           << metalInventory.r5Eviction.authoritativePrimaryEvictAttempts
           << ","
           << "\"primaryBufferReleaseAttempts\":"
           << metalInventory.r5Eviction.primaryBufferReleaseAttempts << ","
           << "\"hostShadowMutationAttempts\":"
           << metalInventory.r5Eviction.hostShadowMutationAttempts << ","
           << "\"setPurgeableStateCalls\":"
           << metalInventory.r5Eviction.setPurgeableStateCalls << ","
           << "\"lastBudget\":"
           << metalInventory.r5Eviction.lastBudget << ","
           << "\"lastPreTextureViewCount\":"
           << metalInventory.r5Eviction.lastPreTextureViewCount << ","
           << "\"lastPostTextureViewCount\":"
           << metalInventory.r5Eviction.lastPostTextureViewCount << ","
           << "\"lastPreTextureViewBytes\":"
           << metalInventory.r5Eviction.lastPreTextureViewBytes << ","
           << "\"lastPostTextureViewBytes\":"
           << metalInventory.r5Eviction.lastPostTextureViewBytes << ","
           << "\"lastPreExpandedIndexBuffers\":"
           << metalInventory.r5Eviction.lastPreExpandedIndexBuffers << ","
           << "\"lastPostExpandedIndexBuffers\":"
           << metalInventory.r5Eviction.lastPostExpandedIndexBuffers << ","
           << "\"lastPreExpandedIndexBytes\":"
           ...
           << ","
           << "\"primaryTexture\":"
           << metalInventory.r5Eviction.reconstructablePrimariesEvicted
           << "},"
           ...
           << metalInventory.r5Eviction.recordsEvictedExpandedIndexCache
           << ","
           << "\"reconstructablePrimariesEvicted\":"
           << metalInventory.r5Eviction.reconstructablePrimariesEvicted
           << ","
           << "\"deviceBytesFreed\":"
           ...
           << metalInventory.r5Eviction.reclaimedHostCacheBytes << ","
           << "\"evictedPrimaryBytesByClass\":{"
           << "\"reconstructable\":"
           << metalInventory.r5Eviction.evictedPrimaryReconstructableBytes
           << ","
           << "\"authoritative\":"
           << metalInventory.r5Eviction.evictedPrimaryAuthoritativeBytes
           << "},"
           << "\"textureViewRebuildsAfterR5Evict\":"
           ...
           << metalInventory.r5Eviction.primaryReconstructions << ","
           << "\"primaryReconstructionFailures\":"
           << metalInventory.r5Eviction.primaryReconstructionFailures << ","
           << "\"primaryVolatileRestoreAttempts\":"
           << metalInventory.r5Eviction.primaryVolatileRestoreAttempts << ","
           << "\"primaryVolatileRestoreKept\":"
           << metalInventory.r5Eviction.primaryVolatileRestoreKept << ","
    ...
    stream << "\"r5Touches\":{"
           ...
           << ","
           << "\"bufferBindTouches\":"
           << metalInventory.r5Touches.bufferBindTouches << ","
           << "\"textureBindTouches\":"
           << metalInventory.r5Touches.textureBindTouches << ","
           << "\"samplerBindTouches\":"
           << metalInventory.r5Touches.samplerBindTouches << ","
           << "\"renderbufferBindTouches\":"
           << metalInventory.r5Touches.renderbufferBindTouches << ","
           << "\"framebufferBindTouches\":"
           << metalInventory.r5Touches.framebufferBindTouches << ","
           << "\"vertexArrayBindTouches\":"
           << metalInventory.r5Touches.vertexArrayBindTouches << ","
           << "\"vertexBufferBindTouches\":"
           << metalInventory.r5Touches.vertexBufferBindTouches << ","
           << "\"programBindTouches\":"
           << metalInventory.r5Touches.programBindTouches << ","
           << "\"drawTouches\":" << metalInventory.r5Touches.drawTouches
           << ","
           << "\"dispatchTouches\":"
    ...
    stream << "\"r5Ordering\":{"
           ...
           << "\"primaryTextureCandidateRows\":"
           << metalInventory.r5Ordering.primaryTextureCandidateRows << ","
           << "\"primaryTextureCandidateBytes\":"
           << metalInventory.r5Ordering.primaryTextureCandidateBytes << ","
    ...
    stream << "\"hostCaches\":{"
           ...
           << ","
           << "\"bufferShadowObjects\":"
           << metalInventory.hostCaches.bufferShadowObjects << ","
           << "\"bufferShadowBytes\":"
           << metalInventory.hostCaches.bufferShadowBytes << ","
           << "\"textureShadowImages\":"
           ...
           << "\"expandedIndexBytes\":"
           << metalInventory.hostCaches.expandedIndexBytes << ","
           << "\"fp64Sidecars\":" << metalInventory.hostCaches.fp64Sidecars
           << ","
           << "\"fp64SidecarCpuBytes\":"
           << metalInventory.hostCaches.fp64SidecarCpuBytes << ","
           << "\"shaderSourceBytes\":"
           << metalInventory.hostCaches.shaderSourceBytes << ","
           << "\"shaderSpirvBytes\":"
           << metalInventory.hostCaches.shaderSpirvBytes << ","
           << "\"programMslSourceBytes\":"
           << metalInventory.hostCaches.programMslSourceBytes << ","
           << "\"mslLibraryCacheSourceBytes\":"
           << metalInventory.hostCaches.mslLibraryCacheSourceBytes << ","
           << "\"mslLibraryCacheSourceKeyBytes\":"
           << metalInventory.hostCaches.mslLibraryCacheSourceKeyBytes << ","
           << "\"mslLibraryCompileTransientSourceBytes\":"
           << metalInventory.hostCaches.mslLibraryCompileTransientSourceBytes
           << ","
           << "\"sparseBufferPageTableBytes\":"
           << metalInventory.hostCaches.sparseBufferPageTableBytes << ","
           << "\"textureBufferExpansionMetalBuffers\":"
           << metalInventory.hostCaches.textureBufferExpansionMetalBuffers
           << ","
           << "\"textureBufferExpansionMetalBufferBytes\":"
           << metalInventory.hostCaches.textureBufferExpansionMetalBufferBytes
           << ","
           << "\"imageAtomicSidecars\":"
           << metalInventory.hostCaches.imageAtomicSidecars << ","
           << "\"imageAtomicSidecarBytes\":"
           << metalInventory.hostCaches.imageAtomicSidecarBytes << ","
           << "\"sparseTextureHeaps\":"
           << metalInventory.hostCaches.sparseTextureHeaps << ","
           << "\"sparseTextureHeapBytes\":"
           << metalInventory.hostCaches.sparseTextureHeapBytes << ","
           << "\"sparseStorageImageSidecars\":"
           << metalInventory.hostCaches.sparseStorageImageSidecars << ","
           << "\"sparseStorageImageSidecarBytes\":"
           << metalInventory.hostCaches.sparseStorageImageSidecarBytes << ","
           << "\"multisampleStorageImageSidecars\":"
           << metalInventory.hostCaches.multisampleStorageImageSidecars
           << ","
           << "\"multisampleStorageImageSidecarBytes\":"
...
void APIENTRY glGetFragmentShadingRatesEXT(GLsizei samples, GLsizei maxCount, GLsizei* count, GLenum* shadingRates) {
    ...
    if (!context->getFragmentShadingRatesEXT(samples, maxCount, count, shadingRates)) {
        return;
    }
    markStateFunction(
...
void APIENTRY glShadingRateEXT(GLenum rate) {
    ...
    if (!context->shadingRateEXT(rate)) {
        return;
    }
...
void APIENTRY glShadingRateCombinerOpsEXT(GLenum combinerOp0, GLenum combinerOp1) {
    ...
    if (!context->shadingRateCombinerOpsEXT(combinerOp0, combinerOp1)) {
        return;
    }
    markStateFunction(
...
void APIENTRY glFramebufferShadingRateEXT(GLenum target,
    ...
    (void)context->framebufferShadingRateEXT(
        target,
        attachment,
        texture,
        baseLayer,
...
void APIENTRY glUseProgram(GLuint program) {
    ...
    // GL 4.6 §13.2.2: INVALID_OPERATION generated by UseProgram (any
    // program, including 0) when transform feedback is active and not
    // paused. The strict spec behavior is enforced inside
    // GLContext::useProgram (CKPT101); the duplicate dispatch-side check
    // is removed.
    //
    // Historical note (CKPT101): an older dispatch-side workaround
    // auto-ended TF on useProgram(0) to unblock CTS's gluStateReset
    // sequence (which calls useProgram(0) before endTransformFeedback)
    // when our TF was a stub. Now that TF is fully implemented (Sprint
    // 7+8 work + per-TF-object tracking via CKPT85), the workaround
    // both violates the spec (CTS api_errors_test asserts
    // INVALID_OPERATION on this exact call) AND is no longer needed
    // (gluStateReset doesn't depend on the auto-end behavior because
    // its later endTransformFeedback call works correctly).
    //
    // The context-side check at GLContext::useProgram raises
    // INVALID_OPERATION cleanly without state-mutation side effects.
...
void APIENTRY glDrawTransformFeedback(GLenum mode, GLuint id) {
    ...
    if (!ctx) return;
    // GL 4.6 §10.5: INVALID_VALUE if id is not the name of a transform
    // feedback object. CKPT101: use the same instantiation check as
    // glIsTransformFeedback (obj != nullptr && obj->instantiated).
    // Reserved-but-never-bound names should also fail this check —
    // CTS api_errors_test iterates `while (isTransformFeedback(id)) ++id`
    // until isTransformFeedback returns false, then expects
    // drawTransformFeedback(id) to raise INVALID_VALUE. With the prior
    // weaker `contains(id)` check, reserved-but-not-instantiated names
    // wrongly fell through to the hasCompleted INVALID_OPERATION path.
    auto* tfObj = (id != 0) ? ctx->objects().transformFeedbacks().get(id) : nullptr;
    if (id != 0 && (tfObj == nullptr || !tfObj->instantiated)) {
...
void APIENTRY glDrawTransformFeedbackInstanced(GLenum mode, GLuint id, GLsizei instancecount) {
    ...
    // CKPT101 sister-bug audit: use instantiation check matching
    // glIsTransformFeedback semantics (sister to glDrawTransformFeedback).
    {
        auto* tfObjValid = (id != 0) ? ctx->objects().transformFeedbacks().get(id) : nullptr;
        if (id != 0 && (tfObjValid == nullptr || !tfObjValid->instantiated)) {
            ...
            if (prog && prog->gsPresent) {
                auto compat = [](GLenum gsTopo, GLenum drawMode) -> bool {
                    switch (gsTopo) {
                        ...
                        default:
                            return true;   // unknown; accept (defensive)
                    }
                };
                if (!compat(prog->gsOutputTopology, mode)) {
...
void APIENTRY glDrawTransformFeedbackStreamInstanced(GLenum mode, GLuint id, GLuint stream, GLsizei instancecount) {
    ...
    // GL 4.6 §10.5: INVALID_VALUE if id is not a valid transform feedback object.
    // CKPT101 sister-bug audit: instantiation check.
    {
        auto* tfObjValid = (id != 0) ? ctx->objects().transformFeedbacks().get(id) : nullptr;
        if (id != 0 && (tfObjValid == nullptr || !tfObjValid->instantiated)) {
            recordValidationError(ctx, "glDrawTransformFeedbackStreamInstanced", GL_INVALID_VALUE,
...
extern "C" std::uint64_t appglR5EvictDerivedCachesForTesting(std::uint64_t budget) {
