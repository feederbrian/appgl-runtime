...
public:
    ...
    bool copyTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
    ...
    bool namedFramebufferTexture1DEXT(GLuint framebuffer, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
    bool namedFramebufferTexture2DEXT(GLuint framebuffer, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
    bool namedFramebufferTexture3DEXT(GLuint framebuffer, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset);
    bool namedFramebufferTextureFaceEXT(GLuint framebuffer, GLenum attachment, GLuint texture, GLint level, GLenum face);
    ...
    struct MetalResourceInventory {
        ...
        std::uint64_t frameGraphDefaultMsaaColorTextureBytes = 0;
        std::uint64_t frameGraphDefaultMsaaColorTextureWidth = 0;
        std::uint64_t frameGraphDefaultMsaaColorTextureHeight = 0;
        std::uint64_t frameGraphDefaultMsaaColorTextureSampleCount = 0;
        std::uint64_t frameGraphDefaultMsaaColorTexturePixelFormat = 0;
        std::uint64_t frameGraphDefaultMsaaColorRebuilds = 0;
        std::uint64_t frameGraphDefaultMsaaColorReleases = 0;
        std::uint64_t frameGraphDefaultMsaaColorAllocatedBytes = 0;
        std::uint64_t frameGraphDefaultMsaaDepthStencilTextureBytes = 0;
        std::uint64_t frameGraphDefaultMsaaDepthStencilTextureWidth = 0;
        std::uint64_t frameGraphDefaultMsaaDepthStencilTextureHeight = 0;
        std::uint64_t frameGraphDefaultMsaaDepthStencilTextureSampleCount = 0;
        std::uint64_t frameGraphDefaultMsaaDepthStencilTexturePixelFormat = 0;
        std::uint64_t frameGraphDefaultMsaaDepthStencilRebuilds = 0;
        std::uint64_t frameGraphDefaultMsaaDepthStencilReleases = 0;
        std::uint64_t frameGraphDefaultMsaaDepthStencilAllocatedBytes = 0;
        std::uint64_t frameGraphDefaultMsaaColorResolveDirty = 0;
