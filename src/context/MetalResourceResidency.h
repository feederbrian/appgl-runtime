...
struct MetalTextureMipShadowEvictionSummary {
    std::uint64_t enabled = 0;
    std::uint64_t uploadedMipDropEnabled = 0;
    std::uint64_t evictCalls = 0;
    std::uint64_t evictedImages = 0;
    std::uint64_t evictedRgba8Bytes = 0;
    std::uint64_t evictedNativeBytes = 0;
    std::uint64_t evictedBytes = 0;
    std::uint64_t liveEvictedImages = 0;
    std::uint64_t liveEvictedRgba8Bytes = 0;
    std::uint64_t liveEvictedNativeBytes = 0;
    std::uint64_t liveEvictedBytes = 0;
    std::uint64_t materializeCalls = 0;
    std::uint64_t materializeBytes = 0;
    std::uint64_t materializeFailures = 0;
    std::uint64_t materializeGetTextureImageCalls = 0;
    std::uint64_t materializeGetTextureSubImageCalls = 0;
    std::uint64_t materializeCopyImageSubDataCalls = 0;
    std::uint64_t materializeTexSubImageCalls = 0;
    std::uint64_t materializeClearTexCalls = 0;
    std::uint64_t materializeGenerateMipmapCalls = 0;
    std::uint64_t materializeUploadRebuildCalls = 0;
    std::uint64_t blockLevelZeroOrNegative = 0;
    std::uint64_t blockNotGeneratedOrImmutable = 0;
    std::uint64_t blockNotInstantiated = 0;
    std::uint64_t blockNoMetalTexture = 0;
    std::uint64_t blockObjectState = 0;
    std::uint64_t blockViewSource = 0;
    std::uint64_t blockDependentView = 0;
    std::uint64_t blockSparse = 0;
    std::uint64_t blockImageAtomic = 0;
    std::uint64_t blockAuthoritative = 0;
    std::uint64_t blockRendered = 0;
    std::uint64_t blockPending = 0;
    std::uint64_t blockSamplingProxy = 0;
    std::uint64_t blockUnsupportedTarget = 0;
    std::uint64_t blockUnsupportedFormat = 0;
    std::uint64_t blockPrivateStorage = 0;
    std::uint64_t blockNoShadowBytes = 0;
    std::uint64_t blockMetalLevelOob = 0;
};
...
struct MetalHostCacheSummary {
    ...
    std::uint64_t textureShadowRgba8Bytes = 0;
    std::uint64_t textureShadowNativeBytes = 0;
    std::uint64_t textureShadowCapacityBytes = 0;
    std::uint64_t textureShadowPrimaryImages = 0;
    std::uint64_t textureShadowPrimaryBytes = 0;
    std::uint64_t textureShadowPrimaryRgba8Bytes = 0;
    std::uint64_t textureShadowPrimaryNativeBytes = 0;
    std::uint64_t textureShadowPrimaryCapacityBytes = 0;
    std::uint64_t textureShadowMipImages = 0;
    std::uint64_t textureShadowMipBytes = 0;
    std::uint64_t textureShadowMipRgba8Bytes = 0;
    std::uint64_t textureShadowMipNativeBytes = 0;
    std::uint64_t textureShadowMipCapacityBytes = 0;
    MetalTextureMipShadowEvictionSummary textureMipShadowEviction;
    std::uint64_t depth32fDropDryRunCandidateTextures = 0;
    std::uint64_t depth32fDropDryRunCandidateRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunEligibleTextures = 0;
    std::uint64_t depth32fDropDryRunEligibleRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunBlockedTextures = 0;
    std::uint64_t depth32fDropDryRunBlockedRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunFlagViewTextures = 0;
    std::uint64_t depth32fDropDryRunFlagViewRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunFlagSparseTextures = 0;
    std::uint64_t depth32fDropDryRunFlagSparseRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunFlagImageAtomicTextures = 0;
    std::uint64_t depth32fDropDryRunFlagImageAtomicRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunFlagColorAuthoritativeTextures = 0;
    std::uint64_t depth32fDropDryRunFlagColorAuthoritativeRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunFlagDepthAuthoritativeTextures = 0;
    std::uint64_t depth32fDropDryRunFlagDepthAuthoritativeRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunFlagRenderedTextures = 0;
    std::uint64_t depth32fDropDryRunFlagRenderedRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunFlagPendingTextures = 0;
    std::uint64_t depth32fDropDryRunFlagPendingRgba8Bytes = 0;
    std::uint64_t depth32fDropDryRunFlagSamplingProxyTextures = 0;
    std::uint64_t depth32fDropDryRunFlagSamplingProxyRgba8Bytes = 0;
    std::uint64_t cubeFaceShadowImages = 0;
    std::uint64_t cubeFaceShadowBytes = 0;
    std::uint64_t cubeFaceShadowRgba8Bytes = 0;
    std::uint64_t cubeFaceShadowNativeBytes = 0;
    std::uint64_t cubeFaceShadowCapacityBytes = 0;
    std::uint64_t renderbufferShadowObjects = 0;
    std::uint64_t renderbufferShadowBytes = 0;
    std::uint64_t renderbufferShadowRgba8Bytes = 0;
    std::uint64_t renderbufferShadowNativeBytes = 0;
    std::uint64_t renderbufferShadowDepth32Bytes = 0;
    std::uint64_t renderbufferShadowStencil8Bytes = 0;
    std::uint64_t renderbufferShadowCapacityBytes = 0;
...
static_assert(std::is_standard_layout<MetalTextureMipShadowEvictionSummary>::value,
              "MetalTextureMipShadowEvictionSummary must remain POD-shaped");
